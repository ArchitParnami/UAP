...
def main():
    ...
    source_locs, source_names = read_rail_station_info()
    destination_locs, destination_names = read_fire_station_info(load_dist)
    header = 'date,time,RailStation,FireStation,T1,D1,T2,D2,T3,D3\n'
    cycles = 0
